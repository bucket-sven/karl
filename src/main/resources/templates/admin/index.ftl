                ...
                <div class="ibox-content">
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td>
                                <a xhref="/admin/remove?id=${admin.id}" class="admin-remove" title="删除操作"><i
                                        class="glyphicon glyphicon-remove"></i>
                                </a>
                                <a jsonStr="{'id':'${admin.id}','name':'${(admin.member.name)!''}','sex':'${(admin.member.sex)!''}','birthday':'${(admin.member.birthday?date)!''}','username':'${(admin.user.username)!''}'}"
                                   class="admin-update"
                                   title="修改操作">
