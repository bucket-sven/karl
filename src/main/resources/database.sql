create database if not exists karl;
use karl;

-- MySQL dump 10.13  Distrib 5.6.24, for Win32 (x86)
--
-- Host: localhost    Database: karl
-- ------------------------------------------------------
